...
import bg from "../Assets/boss1.jpg";

 function Home() {
  return (
    <>
    <div 
      className="h-screen bg-cover bg-center flex justify-center items-center animate__animated animate__fadeInUp" 
      style={{ backgroundImage: `url(${bg})`, height: '595px', }}
                 ...
                 style={{transform: 'translateZ(0px) translateY(0%)'}}>
                    <div className="flex">
                        <div className="col-span-7 px-14">
                            <p className="mb-4 pl-5 line  text-black font-bold text-xl" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }" style={{opacity: 1, transform: 'translateZ(0px) translateY(0%)'}}>
                                A small river named Duden flows by their place and supplies
                            </p>
                        </div>
                    </div>
                    <h1 className="mb-4 font-extrabold text-5xl text-black px-20" style={{opacity: 1, transform: 'translateZ(0px) translateY(0%)'}}>
            ...
            <div className="grid grid-cols-3 gap-4 items-stretch mx-5">
              <div className="animate__fadeInUp animate__animated">
                <div className="services-1">
                  ...
                  <div className="tems-center flex flex-col justify-center text-white hover:text-yellow-500 hover:border-yellow-500 transition-colors duration-200 easemedia-body cursor-default bg-blue-900 w-50 h-60 border-2 border-transparent i-in-out">
